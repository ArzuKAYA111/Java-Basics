...
public class Questions {
	...
	public static void main(String[] args) {
		...
		System.out.println("........  ");
		Arrays.sort(array);// sorted the array in ascending order.
		System.out.println(array[0]);// ilk girilen John du ama suraya koyduktan sonra Enson yazmis olsak ta alfabetik olan ilk alijon oldugu icin o cikti.
		
		//to sort elements of any collection
		//collections is a utility class that have methods to work with collections
		Collections.sort(list);// sorted the list collection in ascending order.
		System.out.println(list);

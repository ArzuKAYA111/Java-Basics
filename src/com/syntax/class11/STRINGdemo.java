...
public class STRINGdemo {
	...
	public static void main(String[] args) {
		 ...
		 String school=" Syntax "; // by literal
		 
	        String str=new String("HELLO");
	        String str1="This a String 7676,&^&^";
	        
	        // String has how many characters
	...
	// tels true if there is no characters inside the String
	...
	// removes empty/white space at the beginning and end of the String
		...
		str4=str4.trim();
		System.out.println(" String with no leadind or tralling space : "+ str4);

...
public class EntrySet {
	...
	public static void main(String[] args) {
		...
		System.out.println("---loop through all entries to get all keys and correspond values ");
		...
		System.out.println("---iterate through all entries to get all keys and correspond values ");
		Iterator<Entry<String, String>> entryIterator=allEntries.iterator();
		while(entryIterator.hasNext()) {
			Entry<String, String> e=entryIterator.next();
			String keyANDvalue = e.getKey()+":::"+e.getValue();
